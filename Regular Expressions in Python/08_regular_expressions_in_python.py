...
# Complete the f-string (field1 with quotes)
print(f"Data science is considered {field1!r} in the {fact1}st century")

# Complete the f-string (fact2 with exponential notation)
print(f"About {fact2:e} of {field2} in the world")

# Complete the f-string (fact3 rounded by 2 decimals and fact4 rounded by 1 decimal)
